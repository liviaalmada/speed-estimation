...
public class TrajectoryAsSet implements Comparable<TrajectoryAsSet>{
	...
	private ArrayList<Double> edge_offset; // depois do map-matching
	...
	public TrajectoryAsSet(int _uid, int _tid, Geometry _geom, ArrayList<Long> time_array,
		...
		this.edge_array=new ArrayList<Edge>(time_array.size());
		this.edge_offset=new ArrayList<Double>(time_array.size());
	}
	...
	public TrajectoryAsSet(int _uid, int _tid, ArrayList<Long> time_array,ArrayList<Coordinate> coord_array) {
		...
		this.edge_offset=new ArrayList<Double>();
	}
	...
	public ArrayList<Double> getEdge_offset() {
		return edge_offset;
	}


	public void setEdge_offset(ArrayList<Double> edge_offset) {
